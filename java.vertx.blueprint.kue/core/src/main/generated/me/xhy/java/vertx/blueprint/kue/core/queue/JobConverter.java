...
/**
 * Converter for {@link me.xhy.java.vertx.blueprint.kue.core.queue.Job}.
 *
 * NOTE: This class has been automatically generated from the {@link me.xhy.java.vertx.blueprint.kue.core.queue.Job} original class using Vert.x codegen.
 */
public class JobConverter {
  ...
  public static void fromJson(JsonObject json, Job obj) {
    ...
    if (json.getValue("priority") instanceof String) {
      obj.setPriority(me.xhy.java.vertx.blueprint.kue.core.queue.Priority.valueOf((String)json.getValue("priority")));
    }
    ...
    if (json.getValue("state") instanceof String) {
      obj.setState(me.xhy.java.vertx.blueprint.kue.core.queue.JobState.valueOf((String)json.getValue("state")));
    }
