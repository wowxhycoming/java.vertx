...
/** @module vertx-blueprint-kue-core-module-js/callback_kue */
var utils = require('vertx-js/util/utils');
var Vertx = require('vertx-js/vertx');
var Message = require('vertx-js/message');
var JobService = require('vertx-blueprint-kue-core-service-module-js/job_service');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JCallbackKue = Java.type('me.xhy.java.vertx.blueprint.kue.core.CallbackKue');
...
var CallbackKue = function(j_val) {
  ...
  this.cardByType = function(type, state, handler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_callbackKue["cardByType(java.lang.String,me.xhy.java.vertx.blueprint.kue.core.queue.JobState,io.vertx.core.Handler)"](type, me.xhy.java.vertx.blueprint.kue.core.queue.JobState.valueOf(state), function(ar) {
      if (ar.succeeded()) {
  ...
  this.card = function(state, handler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_callbackKue["card(me.xhy.java.vertx.blueprint.kue.core.queue.JobState,io.vertx.core.Handler)"](me.xhy.java.vertx.blueprint.kue.core.queue.JobState.valueOf(state), function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnLong(ar.result()), null);
      } else {
        handler(null, ar.cause());
  ...
  this.getIdsByState = function(state, handler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_callbackKue["getIdsByState(me.xhy.java.vertx.blueprint.kue.core.queue.JobState,io.vertx.core.Handler)"](me.xhy.java.vertx.blueprint.kue.core.queue.JobState.valueOf(state), function(ar) {
      if (ar.succeeded()) {
  ...
  this.saveJob = function(job, handler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_callbackKue["saveJob(me.xhy.java.vertx.blueprint.kue.core.queue.Job,io.vertx.core.Handler)"](job != null ? new Job(new JsonObject(Java.asJSONCompatible(job))) : null, function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnDataObject(ar.result()), null);
      } else {
        handler(null, ar.cause());
  ...
  this.jobProgress = function(job, complete, total, handler) {
    ...
    if (__args.length === 4 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] ==='number' && typeof __args[2] ==='number' && typeof __args[3] === 'function') {
      j_callbackKue["jobProgress(me.xhy.java.vertx.blueprint.kue.core.queue.Job,int,int,io.vertx.core.Handler)"](job != null ? new Job(new JsonObject(Java.asJSONCompatible(job))) : null, complete, total, function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnDataObject(ar.result()), null);
      } else {
        handler(null, ar.cause());
  ...
  this.jobDone = function(job) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      j_callbackKue["jobDone(me.xhy.java.vertx.blueprint.kue.core.queue.Job)"](job != null ? new Job(new JsonObject(Java.asJSONCompatible(job))) : null);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.jobDoneFail = function(job, ex) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'object') {
      j_callbackKue["jobDoneFail(me.xhy.java.vertx.blueprint.kue.core.queue.Job,java.lang.Throwable)"](job != null ? new Job(new JsonObject(Java.asJSONCompatible(job))) : null, utils.convParamThrowable(ex));
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
CallbackKue._jclass = utils.getJavaClass("me.xhy.java.vertx.blueprint.kue.core.CallbackKue");
CallbackKue._jtype = {
  accept: function(obj) {
...
/**
 ...
 @memberof module:vertx-blueprint-kue-core-module-js/callback_kue
 @param vertx {Vertx} 
 @param config {Object} 
 @return {CallbackKue}
 */
