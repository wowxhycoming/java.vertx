package me.xhy.java.vertx.o4JDBC;
...
public class JDBC extends AbstractVerticle {
	...
	public void start(Future<Void> fut) {
		...
		jdbc = JDBCClient.createShared(vertx, new JsonObject()
				...
				.put("user", "test")
				.put("password", "123456")
//				.put("url", "jdbc:oracle:thin:@10.6.10.203:1521/kptdb")
//				.put("user", "n9zhxdz")
//				.put("password", "sasasa")
...
//				ORACLE : create table WHISKY(id VARCHAR2(10) not null,  name VARCHAR2(10), origin VARCHAR2(10));
//					alter table WHISKY  add constraint WHISKY_ID primary key (ID);
					"select 1 from dual",
					ar -> {
						if (ar.failed()) {
